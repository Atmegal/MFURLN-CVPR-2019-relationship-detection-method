...
def generate_train_rela_roidb(roidb, dete_box, iou_l, N_each_batch, N_each_pair):
	...
	roidb_temp = {'image': roidb['image'], 'rela_gt': roidb_rela,
				  ...
				  'obj_dete': obj_dete2, 'rela_dete': rela_dete, 'is_pair': is_pair, 'right_index': right_index, 'wrong_index': wrong_index, 'sub_score': np.array(sub_score1), 'obj_score': np.array(obj_score1)}
