	...
	if stop == 2:
		...
		pRso_100 = 0.
                for val_id in range(N_val):
                    ...
                    rela_R50, rela_num_right50 = rela_recall_r([val_roidb[val_id]], [pred_roidb_temp], 50)
                    rela_R100, rela_num_right100 = rela_recall_r([val_roidb[val_id]], [pred_roidb_temp], 100)

                    phrase_R50, rela_num_right50 = phrase_recall_r([val_roidb[val_id]], [pred_roidb_temp], 50)
                    phrase_R100, rela_num_right100 = phrase_recall_r([val_roidb[val_id]], [pred_roidb_temp], 100)
