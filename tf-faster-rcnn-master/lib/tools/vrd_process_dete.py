...
N_obj = 101
DIR = '/media/hp/189EA2629EA23860/work/visual_relation/'
train_file_path = DIR + 'dataset/VRD/json_dataset/annotations_train.json'
test_file_path = DIR + 'dataset/VRD/json_dataset/annotations_test.json'
