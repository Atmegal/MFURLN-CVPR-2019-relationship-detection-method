...
save_path = 'vrd_detected_box.npz'
model_path = '/media/hp/C440AC3040AC2ADE/zyb/CVPR/MFURLN/tf-faster-rcnn-master/lib/output/VRD/vgg16_faster_rcnn_iter_60000.ckpt'

num_classes = 101
vrd_roidb = np.load('vrd_roidb.npz')
roidb_temp = vrd_roidb['roidb']
roidb = roidb_temp[()]
