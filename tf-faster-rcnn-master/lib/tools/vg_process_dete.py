...
N_obj = 201
file_path = '/media/zhan/189EA2629EA23860/work/visual_relation/dataset/VG/imdb/vg1_2_meta.h5'
image_path = '/media/zhan/189EA2629EA23860/work/visual_relation/dataset/VG/images/VG_100K/'
...
for r in range(2):
	...
	if r == 0:	
		val_roidb = roidb[68794:]
		roidb1 = []
		roidb1.extend(roidb[:68794])
		roidb = []
		roidb.extend(roidb1)
		N_roidb = len(roidb)
...
print(len(val_roidb), len(train_roidb), len(test_roidb))
